...
def Late_Unet(
    ...
    Lubka ADDITION: late_fusion=False: default
                                if True: perform late fusion with two inputs, use build_LATE_unet instead of build_unet
    ...
    if encoder_features == 'default': # this part could be used to rename them an not have to use different backbones???
        encoder_features = Backbones.get_feature_layers(backbone_name, n=4)


    if late_fusion:
            model = build_LATE_unet(
            backbone=backbone, 
